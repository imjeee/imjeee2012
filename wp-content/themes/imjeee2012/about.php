  ...
  <div class="right">
    <div id="about">
      ...
      <div class="section">
        <div class="block">
          <h1>School + work</h1>
          <p>I went <a href-"http://www.mica.edu" target="_blank">Maryland Institute College of Art</a> after high school. Then I worked at <a href="http://www.ainq.com" target="_blank">Audacious Inquiry</a> as an interactive designer. After 2 years, I combined by passion for technology and design by studying Computer Science at <a href="http://www.utexas.edu" target="_blank">University of Texas at Austin</a>. Now I'm at Ebay Austin working as a software developer!.</p>
        </div><!-- .block -->
        <div class="timeline">
          <ul class="intervals">
            <li>2004</li>
